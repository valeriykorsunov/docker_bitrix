...
global $arFilter;
$arFilter["PROPERTY_CUSTOMER_ID"] = $USER->GetID();
$arFilter["ACTIVE"] = "Y";
$arFilter["!PROPERTY_CURRENT_STATE"] = 44;


global $arFilterHist;
$arFilterHist["PROPERTY_CUSTOMER_ID"] = $USER->GetID();
	...
	<div class="personal-area__grid">
		...
		<div class="js-tabs b-tabs b-tabs--personal" data-hash>
			<ul class="b-tabs__navigation">
				<li class="b-tabs__navigation-item"><a class="b-tabs__navigation-link" href="#personal-tab1">Now executed</a>
				</li>
				<li class="b-tabs__navigation-item"><a class="b-tabs__navigation-link" href="#personal-tab2">The history of applications</a>
				</li>
			</ul>
