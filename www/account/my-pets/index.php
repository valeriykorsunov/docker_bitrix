...
$APPLICATION->SetTitle("My pets");

$APPLICATION->IncludeComponent("bulldog:account.add_service", "", array("IBLOCK_ID" => "21", "request_handler" => "Y"), false);
$APPLICATION->IncludeComponent("bulldog:my_pet", "", array("IBLOCK_ID" => "15", "request_handler" => "Y"));
...
"CACHE_TYPE" => "A",	// Cache type
		...
		"IBLOCK_ID" => "15",	// Information block code
		"IBLOCK_TYPE" => "pets",	// Type of information block (used for verification only)
