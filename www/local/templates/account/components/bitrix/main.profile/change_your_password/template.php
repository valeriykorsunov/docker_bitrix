...
<div class="b-personal-data__item b-personal-data__item--pink b-personal-data__item--center b-personal-data__item--h-100">
	<form class="form js-validate" method="post" name="form1" action="<?= $arResult["FORM_TARGET"] ?>" enctype="multipart/form-data">
